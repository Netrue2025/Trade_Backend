...
const APP_STATE_READ_TIMEOUT_DEFAULT_MS = 20000;
...
function getAppStateReadTimeoutMs() {
  ...
  return configured
    ? toBoundedNumber(configured, APP_STATE_READ_TIMEOUT_DEFAULT_MS, 10000, 60000)
...
function getAppStateProjectionConcurrency() {
  ...
  return Math.round(configured ? toBoundedNumber(configured, 2, 1, 8) : 2);
}
