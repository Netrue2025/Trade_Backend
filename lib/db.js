...
function getMongoClientOptions() {
  const serverSelectionTimeoutMS = toBoundedNumber(getEnvValue("MONGODB_SERVER_SELECTION_TIMEOUT_MS"), 6000, 1000, 30000);
  const connectTimeoutMS = toBoundedNumber(getEnvValue("MONGODB_CONNECT_TIMEOUT_MS"), 6000, 1000, 30000);
  const socketTimeoutMS = toBoundedNumber(getEnvValue("MONGODB_SOCKET_TIMEOUT_MS"), 15000, 5000, 60000);
  return {
